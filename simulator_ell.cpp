...
/*g++ -O3 -o simulator_ell simulator_ell.cpp graphictools.cpp `sdl2-config --cflags --libs`*/

double EA=0.225; //ellipse major axis
double EB=0.1; //ellipse minor
